...
describe('Form', () => {
  ...
  describe('#handleOnSubmit', () => {
    ...
    describe('when validate is enabled', () => {
      ...
      beforeEach(() => {
        ...
        instance = componentSetup(Form, props);
        shouldComponentUpdate = Form.prototype.shouldComponentUpdate;
        Form.prototype.shouldComponentUpdate = jest.fn();
      ...
      afterEach(() => {
        Form.prototype.shouldComponentUpdate = shouldComponentUpdate;
        jest.clearAllMocks();
      });
  ...
  describe('#shouldComponentUpdate', () => {
    ...
    beforeEach(() => {
      ...
      instance = componentSetup(Form, props);
      resetValidationSpy = jest.spyOn(instance.instance(), 'resetValidation');
